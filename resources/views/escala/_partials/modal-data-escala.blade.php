            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-gruop">
                        ...
                        <input type="text" min="3" name="data_inicio" class="form-control" class="data_inicio" id="data_inicio" value="{{old('data_inicio')}}" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-gruop">
                        ...
                        <input type="text" min="3" name="data_fim" class="form-control" class="data_fim" id="data_fim" value="{{old('data_fim')}}" required>
                    </div>
                </div>
            </div>
        </div>
